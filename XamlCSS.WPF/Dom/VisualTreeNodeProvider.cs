...
namespace XamlCSS.WPF.Dom
{
    ...
    //    public override IEnumerable<DependencyObject> GetVisualChildren(DependencyObject element)
    //    {
    ...
    //    public override DependencyObject GetVisualParent(DependencyObject element)
    //    {
    //        if (element == null)
    //        {
    //            return null;
    ...
    //    public override bool IsInVisualTree(DependencyObject element)
    //    {
