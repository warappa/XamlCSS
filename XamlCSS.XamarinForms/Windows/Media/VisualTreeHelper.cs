...
namespace XamlCSS.Windows.Media
{
    ...
    //        {
    //            var dom = Css.instance?.treeNodeProvider.GetDomElement(element);
    ...
    //            var visualElementPath = element.GetElementPath(Css.instance?.treeNodeProvider, SelectorType.VisualTree);
    //            Debug.WriteLine("  element:\n    " + visualElementPath);
    //            var logicalElementPath = element.GetElementPath(Css.instance?.treeNodeProvider, SelectorType.LogicalTree);
